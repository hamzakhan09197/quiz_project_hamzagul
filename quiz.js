...
async function dataFetching(category, difficulty, noOfQuestions) {
...
async function showResult(userCorrectOption, userName, noOfQuestions, category, difficulty) {
...
async function callFuntion() {
    ...
    while (true) {
        ...
        let noOfQuestions = await numberOfQuestions();
